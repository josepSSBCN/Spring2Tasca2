...
import cat.itacademy.salgadosalichsjosep.s05t02n01.msuser.models.services.PlayServiceMySQL;
...
public class GameController {
    ...
    // Services
    @Autowired
    private PlayServiceMySQL playServiceMySQL;
    ...
    //region CONSTRUCTOR
    {
        ...
        httpHeaders.set("API NAME", "GameController");
    ...
    public ResponseEntity<?> add(@RequestBody PlayBasicDTO playBasicDTOIn) {
        ...
        try {
            ...
            // Call service method
            playServiceMySQL.AddPlay(playBasicDTOIn);
    ...
    public ResponseEntity<?> GetAll(@PathVariable("userName") String userNameIn) {
        ...
        try {
            ...
            // Call Service Method
            playCompletList = new ArrayList<>(playServiceMySQL.GetAll(userNameIn));
    ...
    public ResponseEntity<?> DeleteAll(@PathVariable("userName") String userNameIn) {
        ...
        try {
            ...
            // Call Service Method
            playServiceMySQL.DeleteAll(userNameIn);
